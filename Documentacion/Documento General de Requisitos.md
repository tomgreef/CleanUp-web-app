...
| R2    | Encriptación caché : se encriptará la entrada de la cuenta usuario en LA cache con MD5       |se encriptará la entrada de la cuenta usuario en el cache con MD5 para prevenir que el usuario acceda a rutas no permitidas                                                                         | Fundamental | R3, R3.1           | No Funcional |
